...
class stats:
    def __init__(self, constant):
        ...
        self.types_list = ["mean", "median", "mode", "gmean",
                           "hmean", "range", "quartile", "variance", "std", "cv"]
        self.type = self.types_list[9]
        self.values = []

# Enter the data to calculate

        lb1 = Label(root, text="Enter Data", )
...
# Calculate button with specified command to be select
        ...
        self.type_label.place(relx=.67, rely=.05, relwidth=.15, relheight=.05)
        self.check = Button(constant, text="Calculate",
    ...
    # GUI for Measuring Central of Tendency
        ...
        lable2 = Label(
        root, text="Measuring Central of Tendency", font=('Times', 15))
        lable2.place(relx=.1, rely=.15, relwidth=.9, relheight=.05)
        self.mean = Button(constant, text="Arithmetic Mean",
                       bg="gray", command=self.set_mean)
        self.mean.place(relx=.02, rely=.25, relwidth=.15, relheight=.07)
        self.median = Button(constant, text="Median",
                         bg="gray", command=self.set_median)
        self.median.place(relx=.8, rely=.25, relwidth=.18, relheight=.07)
        self.mode = Button(constant, text="Mode",
                       bg="gray", command=self.set_mode)
        self.mode.place(relx=.6, rely=.25, relwidth=.18, relheight=.07)
        self.gmean = Button(constant, text="Geometric Mean",
                        bg="gray", command=self.set_gmean)
        self.gmean.place(relx=.4, rely=.25, relwidth=.18, relheight=.07)
        self.hmean = Button(constant, text="Harmonic Mean",
                        bg="gray", command=self.set_hmean)
        self.hmean.place(relx=.2, rely=.25, relwidth=.18, relheight=.07)

    # GUI for Measuring Dispersion

        lable2 = Label(root, text="Measuring Dispersion", font=('Times', 15))
        lable2.place(relx=.1, rely=.44, relwidth=.8, relheight=.05)
        self.mean = Button(constant, text="Range",
                       bg="gray", command=self.set_range)
        self.mean.place(relx=.02, rely=.55, relwidth=.15, relheight=.07)
        self.quartile = Button(constant, text="Quartile",
                           bg="gray", command=self.set_quartile)
        self.quartile.place(relx=.8, rely=.55, relwidth=.18, relheight=.07)
        self.variance = Button(constant, text="Variance",
                           bg="gray", command=self.set_variance)
        self.variance.place(relx=.6, rely=.55, relwidth=.18, relheight=.07)
        self.std = Button(constant, text="Standard Deviation",
                      bg="gray", command=self.set_std)
        self.std.place(relx=.4, rely=.55, relwidth=.18, relheight=.07)
        self.cv = Button(constant, text="Coefficient Variance",
                     bg="gray", command=self.set_cv)
        self.cv.place(relx=.2, rely=.55, relwidth=.18, relheight=.07)
        lbv1 = Label(root, text="Version: 1.01 ", )
        lbv1.place(relx=.68, rely=.93, relwidth=.4, relheight=.05,)

    # Result label to be display

        lb0 = Label(root, text="Result: ", font=('Times', 15))
    ...
    # Black line
        ...
        lbv11 = Label(root, text=" ", bg="black",)
